...
from spartangear.views import index, login, cadastro, recuperarsenha, catalogo, produto, carrinho, entrega, pagamento, meucadastro, meuspedidos, pedido, alterarsenha, ajudaeatendimento, sequenciacompras
urlpatterns = [
    ...
    path('cimasequencia', sequenciacompras)
